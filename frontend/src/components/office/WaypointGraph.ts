...
export const OFFICE_WAYPOINTS: Record<string, Waypoint> = {
  ...
  corridor_north: {
    ...
    x: 0.0,
    z: -3.8,
    neighbors: ['aisle_north_west', 'aisle_north_east', 'whiteboard', 'boss_foyer'],
  },
  corridor_south: {
    id: 'corridor_south',
    ...
    x: 0.0,
    z: 2.45,
    neighbors: ['aisle_south_west', 'aisle_south_east', 'desk_alex', 'desk_developer', 'desk_maya', 'desk_qa'],
  },
  aisle_north_west: {
    id: 'aisle_north_west',
  ...
  aisle_south_west: {
    ...
    x: -2.9,
    z: 1.8,
    neighbors: ['corridor_west', 'pantry', 'coffee_lounge', 'corridor_south', 'desk_alex', 'desk_developer'],
  },
  aisle_south_east: {
    id: 'aisle_south_east',
